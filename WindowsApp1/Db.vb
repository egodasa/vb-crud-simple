' Disusun oleh Ego Dafma Dasa
' 10 Oktober 2019 10:46:46 WIB
Imports MySql.Data.MySqlClient
Public Class Db
    Private ReadOnly url_koneksi As String = "server=localhost;user=root;database=contoh;port=3306;password=mysql;"
    ...
    Public Function JalankanDanAmbilSql(ByVal sql As String)
        ResetError()
        If BuatKoneksi() Then
            Try
